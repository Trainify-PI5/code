...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "courses.filterPublished": "Published",
    "courses.filterDraft": "Drafts",
    "courses.filterInProgress": "In Progress",
    "courses.filterCompleted": "Completed",
    "courses.filterNotStarted": "Not Started",
    "courses.badgeDraft": "Draft",
    "courses.editCourse": "Edit Course",
    "courses.viewCourse": "View Course",
    "courses.lesson": "lesson",
    "courses.lessons": "lessons",
    "courses.loading": "Loading courses...",
    "courses.loadError": "Could not load the courses. Please try again.",
    "courses.enrollError": "Could not enroll you in this course. Please try again.",
    "courses.emptyStaff": "No courses yet. Use New Course to create the first one.",
    "courses.emptyStudent": "No courses available for you right now.",
    ...
    "analytics.statusCancelled": "Cancelled",
    "analytics.enrollmentStatus": "Enrollment Status",
    "analytics.enrollmentsByStatus": "Enrollments by status",
    "analytics.courseCompletion": "Completion Rate by Course",
    "analytics.newEnrollments": "Enrollments",
    "analytics.completions": "Completions",
    "analytics.loading": "Loading...",
    "analytics.loadError": "Could not load the data",
    "analytics.noEnrollments": "No enrollments yet",
  ...
  es: {
    ...
    "courses.filterPublished": "Publicados",
    "courses.filterDraft": "Borradores",
    "courses.filterInProgress": "En Progreso",
    "courses.filterCompleted": "Completados",
    "courses.filterNotStarted": "No Iniciados",
    "courses.badgeDraft": "Borrador",
    "courses.editCourse": "Editar Curso",
    "courses.viewCourse": "Ver Curso",
    "courses.lesson": "leccion",
    "courses.lessons": "lecciones",
    "courses.loading": "Cargando cursos...",
    "courses.loadError": "No se pudieron cargar los cursos. Intentalo de nuevo.",
    "courses.enrollError": "No se pudo inscribirte en este curso. Intentalo de nuevo.",
    "courses.emptyStaff": "Aun no hay cursos. Usa Nuevo Curso para crear el primero.",
    "courses.emptyStudent": "No hay cursos disponibles para ti en este momento.",
    ...
    "analytics.enrollmentStatus": "Estado de las Matrículas",
    "analytics.enrollmentsByStatus": "Matrículas por estado",
    "analytics.courseCompletion": "Tasa de Finalización por Curso",
    "analytics.newEnrollments": "Matrículas",
    "analytics.completions": "Finalizaciones",
    "analytics.loading": "Cargando...",
    "analytics.loadError": "No se pudieron cargar los datos",
    "analytics.noEnrollments": "Aún no hay matrículas",
  ...
  "pt-BR": {
    ...
    "courses.filterSoftSkills": "Soft Skills",
    "courses.filterPublished": "Publicados",
    "courses.filterDraft": "Rascunhos",
    "courses.filterInProgress": "Em Andamento",
    "courses.filterCompleted": "Concluídos",
    "courses.filterNotStarted": "Não Iniciados",
    "courses.badgeDraft": "Rascunho",
    "courses.editCourse": "Editar Curso",
    "courses.viewCourse": "Ver Curso",
    "courses.lesson": "aula",
    "courses.lessons": "aulas",
    "courses.loading": "Carregando cursos...",
    "courses.loadError": "Não foi possível carregar os cursos. Tente novamente.",
    "courses.enrollError": "Não foi possível matricular você neste curso. Tente novamente.",
    "courses.emptyStaff": "Nenhum curso ainda. Use Novo Curso para criar o primeiro.",
    "courses.emptyStudent": "Nenhum curso disponível para você no momento.",
    ...
    "analytics.statusStarted": "Iniciado",
    "analytics.statusCancelled": "Cancelado",
    "analytics.enrollmentStatus": "Status das Matrículas",
    "analytics.enrollmentsByStatus": "Matrículas por status",
    "analytics.courseCompletion": "Taxa de Conclusão por Curso",
    "analytics.newEnrollments": "Matrículas",
    "analytics.completions": "Conclusões",
    "analytics.loading": "Carregando...",
    "analytics.loadError": "Não foi possível carregar os dados",
    "analytics.noEnrollments": "Ainda não há matrículas",
    "analytics.week1": "Sem 1",
    "analytics.week2": "Sem 2",
    "analytics.week3": "Sem 3",
    "analytics.week4": "Sem 4",
