...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "courses.seeResults": "See results",
    ...
    "assessment.loadError": "Could not load the assessment.",
    "assessment.submitError": "Could not submit your answers. Please try again.",
    "assessment.lockedError": "Finish the previous lesson to unlock this assessment.",
    "assessment.notConfigured": "Assessment not set up",
    "assessment.notConfiguredDesc": "This lesson has no questions yet.",
    "assessment.back": "Back",
    "assessment.start": "Start assessment",
    "assessment.tryAgain": "Try again",
    "assessment.submit": "Submit answers",
    "assessment.question": "question",
    "assessment.questions": "questions",
    "assessment.passingScore": "Passing score",
    "assessment.attemptsLeft": "Attempts left",
    "assessment.attempt": "Attempt",
    "assessment.alreadyPassed": "You already passed this assessment",
    "assessment.noAttemptsLeft": "You have used every attempt. Talk to your instructor.",
    "assessment.approved": "Approved!",
    "assessment.notApproved": "Not approved yet",
    "assessment.yourScore": "Your score",
    "assessment.of": "of",
    "assessment.correctAnswers": "correct",
    "assessment.review": "Answer review",
  ...
  es: {
    ...
    "courses.seeResults": "Ver resultados",
    ...
    "assessment.loading": "Cargando evaluacion...",
    "assessment.loadError": "No se pudo cargar la evaluacion.",
    "assessment.submitError": "No se pudieron enviar tus respuestas. Intentalo de nuevo.",
    "assessment.lockedError": "Termina la leccion anterior para desbloquear esta evaluacion.",
    "assessment.notConfigured": "Evaluacion no configurada",
    "assessment.notConfiguredDesc": "Esta leccion todavia no tiene preguntas.",
    "assessment.back": "Volver",
    "assessment.start": "Comenzar evaluacion",
    "assessment.tryAgain": "Intentar de nuevo",
    "assessment.submit": "Enviar respuestas",
    "assessment.question": "pregunta",
    "assessment.questions": "preguntas",
    "assessment.passingScore": "Nota minima",
    "assessment.attemptsLeft": "Intentos restantes",
    "assessment.attempt": "Intento",
    "assessment.alreadyPassed": "Ya aprobaste esta evaluacion",
    "assessment.noAttemptsLeft": "Usaste todos los intentos. Habla con tu instructor.",
    "assessment.approved": "Aprobado!",
    "assessment.notApproved": "Aun no aprobado",
    "assessment.yourScore": "Tu nota",
    "assessment.of": "de",
    "assessment.correctAnswers": "correctas",
    "assessment.review": "Revision de respuestas",
    "assessment.yourAnswer": "Tu respuesta",
    "assessment.correctAnswer": "Respuesta correcta",
  ...
  "pt-BR": {
    ...
    "assessment.loadError": "Não foi possível carregar a avaliação.",
    "assessment.submitError": "Não foi possível enviar suas respostas. Tente novamente.",
    "assessment.lockedError": "Conclua a aula anterior para liberar esta avaliação.",
    "assessment.notConfigured": "Avaliação não configurada",
    "assessment.notConfiguredDesc": "Esta aula ainda não tem perguntas cadastradas.",
    "assessment.back": "Voltar",
    "assessment.start": "Iniciar avaliação",
    "assessment.tryAgain": "Tentar novamente",
    "assessment.submit": "Enviar respostas",
    "assessment.question": "pergunta",
    "assessment.questions": "perguntas",
    "assessment.passingScore": "Nota mínima",
    "assessment.attemptsLeft": "Tentativas restantes",
    "assessment.attempt": "Tentativa",
    "assessment.alreadyPassed": "Você já foi aprovado nesta avaliação",
    "assessment.noAttemptsLeft": "Você usou todas as tentativas. Procure o instrutor.",
    "assessment.approved": "Aprovado!",
    "assessment.notApproved": "Ainda não aprovado",
    "assessment.yourScore": "Sua nota",
    "assessment.of": "de",
    "assessment.correctAnswers": "corretas",
    "assessment.review": "Revisão das respostas",
    "assessment.yourAnswer": "Sua resposta",
    "assessment.correctAnswer": "Resposta correta",
